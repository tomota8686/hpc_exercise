...
#pragma omp parallel for
	...
	if (exercise == 28)
	{
		...
		//XXXX 行数は任意
		__m256i mc25600 = _mm256_load_si256((__m256i*)c);
		//XXXX
		__m256i mc25610 = _mm256_load_si256((__m256i*)(c + 8));
		//XXXX
		__m256i temp2560 = _mm256_packs_epi16(mc25600, mc25610);
		...
		_mm256_permute_ps(temp256, mc2560);
